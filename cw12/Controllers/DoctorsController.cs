...
namespace cw12.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdDoctor,FirstName,LastName,Email")] Doctors doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDoctor,FirstName,LastName,Email")] Doctors doctor)
        {
